...
RECODE (36 variables total)
 E_shy_1p E_shy_3p E_shy_4p E_exp_3p E_exp_4p E_ene_5p (6)
 
 A_ego_2p A_ego_7p A_irr_5p A_com_5p A_com_7p A_com_8p A_dom_1p A_dom_7p (8) 
 
 C_ach_8p C_ord_1p C_ord_3p C_ord_4p C_ord_5p C_con_3p C_con_6p C_con_7p (8)
 C_con_8p C_per_1p C_per_2p C_per_3p C_per_5p C_per_6p C_per_8p (7)
 
 S_sel_2p S_sel_4p S_sel_6p (3)
 
 I_cre_1p I_cre_3p I_int_3p I_int_7p (4)  
 (1=5)  (2=4)  (3=3)  (4=2)  (5=1).
 EXECUTE .
